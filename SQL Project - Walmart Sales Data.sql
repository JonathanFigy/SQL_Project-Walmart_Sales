...
-- 5. Which month recorded the largest Cost of Goods Solds (COGS)?
SELECT month_name as Month, SUM(cogs) as goods_sold
FROM sales
GROUP BY month_name;

-- 6. What product line generated the largest revenue?
...
-- 10. What is the most product line by gender?
